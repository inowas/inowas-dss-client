...
import ObservationPointMap from './observationPointEditorMap';
...
class ObservationPointEditor extends React.Component {
    ...
    componentWillMount() {
        ...
        if (this.boundaryContainsObservationPoint(boundary, observationPointId)) {
        ...
        this.setState({
            observationPoint: newObservationPoint
        });
    }
