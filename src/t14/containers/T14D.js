        ...
        return (
            <div className="app-width">
                ...
                <h3 style={styles.heading}>
                    T14D. Partially penetrating stream in an aquitard overlying a pumped aquifer (Hunt, 2003)
                </h3>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(T14D));
