...
import {Background, ChartT14C as Chart, Parameters} from '../components';
...
import {getInitialState} from '../reducers/T14C';
        ...
        return (
            <div className="app-width">
                ...
                <h3 style={styles.heading}>
                    T14C. Partially penetrating stream with streambed resistance (Hunt, 1999)
                </h3>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(T14C));
