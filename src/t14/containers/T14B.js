        ...
        return (
            <div className="app-width">
                ...
                <h3 style={styles.heading}>
                    T14B. Fully penetrating stream with semipervious layer (Hantush, 1965)
                </h3>
...
export default withRouter(connect(mapStateToProps, mapDispatchToProps)(T14B));
