        ...
        <form className="form-horizontal col-md-6">
          ...
          <div className="form-group form-group-sm">
            ...
            <div className="col-sm-9">
              <input onChange={this.updateWellName.bind(this)} value={data.name} name="name" id="inputName" type="text" className="form-control input-sm" placeholder="Well name"/>
            </div>
          </div>
          ...
          <div className="container-flex">
              ...
              <div className="form-group form-group-sm">
                ...
                <div className="col-sm-9 margin-bottom">
                  <div className="input-group input-group-sm">
                    ...
                    <input name="latitude" id="inputLatitude" type="number" step="any" className="form-control input-sm" placeholder="Latitude"/>
                  </div>
                </div>
              </div>
              ...
              <div className="form-group form-group-sm">
                ...
                <div className="col-sm-9">
                  <div className="input-group input-group-sm">
                    ...
                    <input name="name" id="inputLongitude" type="number" step="any" className="form-control input-sm" placeholder="Longitude"/>
                  </div>
                </div>
              </div>
            ...
            <div className="col-flex align-content-center">
              <button data-toggle="tooltip" data-placement="bottom" title="Get from map!" className="btn btn-sm btn-default" type="button">
