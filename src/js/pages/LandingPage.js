                    ...
                    <div className="row toolbox">
                        ...
                        <div className="toolbox-icons">
                            ...
                            <Slider nextPrevNavigation={false} control={(<SliderControl className="toolbox-slider-control">
                                    <SliderControlItem className="toolbox-slider-control-item"><img src="../images/landingPage/toolbox-icon-01.png"/></SliderControlItem>
                                    <SliderControlItem className="toolbox-slider-control-item"><img src="../images/landingPage/toolbox-icon-02.png"/></SliderControlItem>
                                    <SliderControlItem className="toolbox-slider-control-item"><img src="../images/landingPage/toolbox-icon-03.png"/></SliderControlItem>
                                    <SliderControlItem className="toolbox-slider-control-item"><img src="../images/landingPage/toolbox-icon-04.png"/></SliderControlItem>
                                    <SliderControlItem className="toolbox-slider-control-item"><img src="../images/landingPage/toolbox-icon-05.png"/></SliderControlItem>
                                    <SliderControlItem className="toolbox-slider-control-item"><img src="../images/landingPage/toolbox-icon-06.png"/></SliderControlItem>
                                    <SliderControlItem className="toolbox-slider-control-item"><img src="../images/landingPage/toolbox-icon-07.png"/></SliderControlItem>
                                    <SliderControlItem className="toolbox-slider-control-item"><img src="../images/landingPage/toolbox-icon-08.png"/></SliderControlItem>
                                    <SliderControlItem className="toolbox-slider-control-item"><img src="../images/landingPage/toolbox-icon-09.png"/></SliderControlItem>
                                </SliderControl>)}>
