...
export  function calcXtQ0(K, z0, dz, L, W, hi, alpha) {
    const zn = z0+dz;
    var   loop = 1;
    const ht = z0/alpha;
...
const Chart = ({k, z0, l, w, dz, hi, df, ds}) => {
    const alpha = dRho(df, ds);
    var max_iter = 'false'; var valid = 'true';
    var xtQ0  = calcXtQ0(k, z0, 0, l, w, hi, alpha);
    const xt =  xtQ0[0];
    const q0 =  xtQ0[1];    max_iter = xtQ0[2]; valid = xtQ0[3];
        xtQ0  = calcXtQ0(k, z0, dz, l, w, hi-dz, alpha);
    const xt_slr =  xtQ0[0]; const dxt = xt_slr-xt; // slr: after sea level rise
    const q0_slr =  xtQ0[1];
                    ...
                    <div className="diagram">
                        <ResponsiveContainer width={'100%'} aspect={2.0 / 1.0}>
                            <LineChart data={data} margin={{
                                ...
                                <Line isAnimationActive={false} type="basis" dataKey={'z0_new'} stroke="#1EB1ED" strokeWidth="5" dot={false}/>
                            </LineChart>
                        </ResponsiveContainer>
