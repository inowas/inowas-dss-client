        ...
        <div className="padding-30">
            ...
            <div className="center-vertical center-horizontal">
                <p>
                    ...
                    At a distance of <strong>{x} m</strong> to the coast, the initial water table head is <strong>{h.toFixed(1)} m</strong> above sea level and due to sea level rise of <strong>{dz} m</strong>, the water table will rise about <strong>{I.toFixed(2)} m</strong> at that position.
                </p>
            </div>
        </div>
    );
