...
class ModelEditorObservations extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            searchTerm: ''
...
ModelEditorObservations.propTypes = {
...
export default withRouter(
    connect(makeMapStateToPropsBoundaries, mapDispatchToProps)(ConfiguredRadium(ModelEditorObservations))
);
