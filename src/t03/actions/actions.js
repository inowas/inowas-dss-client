...
export const SET_CALCULATION = 'MODEL_EDITOR_SET_CALCULATION';
...
export const DELETE_CALCULATION = 'MODEL_EDITOR_DELETE_CALCULATION';

export function deleteCalculation(tool) {
    return dispatch => {
        dispatch(setCalculation(tool, null));
    };
}
