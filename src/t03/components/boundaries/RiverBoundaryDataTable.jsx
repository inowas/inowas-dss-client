...
class RiverBoundaryDataTable extends DataTable.Component.DataTable {
    constructor(props) {
        super(props);
            ...
            columns: [
                {
                    ...
                    cell: {
                        formatters: [
                            (value, {rowData}) =>
                                !this.props.readOnly && <Icon name={rowData.selected ? 'checked' : 'unchecked'}
...
RiverBoundaryDataTable.propTypes = {
    perPage: PropTypes.number,
};

export default RiverBoundaryDataTable;
