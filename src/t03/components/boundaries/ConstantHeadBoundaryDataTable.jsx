...
class ConstantHeadBoundaryDataTable extends DataTable.Component.DataTable {
    constructor(props) {
        super(props);
...
ConstantHeadBoundaryDataTable.propTypes = {
    perPage: PropTypes.number,
    readOnly: PropTypes.bool,
};

export default ConstantHeadBoundaryDataTable;
