...
class RechargeBoundaryDataTable extends DataTable.Component.DataTable {
    constructor(props) {
        super(props);
        ...
        this.state = {
            ...
            columns: [
                ...
                },
                {
                    ...
                    cell: {
                        transforms: this.props.readOnly ?
                            [] : [DataTable.Helper.editable(this)(edit.input({props: {type: 'number', step: 0.00001}}))],
...
RechargeBoundaryDataTable.propTypes = {
    perPage: PropTypes.number
};

export default RechargeBoundaryDataTable;
