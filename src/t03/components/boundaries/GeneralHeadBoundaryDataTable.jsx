...
class GeneralHeadBoundaryDataTable extends DataTable.Component.DataTable {
    constructor(props) {
        super(props);
...
GeneralHeadBoundaryDataTable.propTypes = {
    perPage: PropTypes.number,
    readOnly: PropTypes.bool,
};

export default GeneralHeadBoundaryDataTable;
