import { LayoutComponents, WebData } from '../../../../core/index';
import Button from '../../../../components/primitive/Button';
import ConfiguredRadium from 'ConfiguredRadium';
import PropTypes from 'prop-types';
import React from 'react';
import Select from '../../../../components/primitive/Select';
import { PcgPackageProperties, NwtPackageProperties, LpfPackageProperties, FlowPropertiesUpw } from '../../index';
...
class MfPackageProperties extends React.Component {
    constructor(props) {
        super( props );
    ...
    render() {
        ...
        switch (selected) {
            case 'nwt':
                ...
                packageComponent = <NwtPackageProperties
            ...
            case 'pcg':
                packageLabel = 'Solver Package';
                packageComponent = <PcgPackageProperties
                    solver={this.state[ selected ]}
                    handleInputChange={this.handleInputChange}
                    getTypeForInput={getTypeForInput}
                    readOnly={readOnly}
            ...
            case 'lpf':
                ...
                packageComponent = <LpfPackageProperties
...
export default ConfiguredRadium(MfPackageProperties);
